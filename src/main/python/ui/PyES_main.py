...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy3.setHeightForWidth(self.comp_label.sizePolicy().hasHeightForWidth())
        self.comp_label.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.species_label.sizePolicy().hasHeightForWidth())
        self.species_label.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.phases_label.sizePolicy().hasHeightForWidth())
        self.phases_label.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.numPhases.sizePolicy().hasHeightForWidth())
        self.numPhases.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.numComp.sizePolicy().hasHeightForWidth())
        self.numComp.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.numSpecies.sizePolicy().hasHeightForWidth())
        self.numSpecies.setSizePolicy(sizePolicy4)
        ...
        self.calc_opt_label.setObjectName(u"calc_opt_label")
        sizePolicy6 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Maximum)
        sizePolicy6.setHorizontalStretch(0)
        sizePolicy6.setVerticalStretch(0)
        sizePolicy6.setHeightForWidth(self.calc_opt_label.sizePolicy().hasHeightForWidth())
        self.calc_opt_label.setSizePolicy(sizePolicy6)
        ...
        sizePolicy2.setHeightForWidth(self.imode.sizePolicy().hasHeightForWidth())
        self.imode.setSizePolicy(sizePolicy2)
        ...
        self.relErrorMode_label.setObjectName(u"relErrorMode_label")
        ...
        self.relErrorMode.addItem("")
        self.relErrorMode.setObjectName(u"relErrorMode")
        ...
        sizePolicy3.setHeightForWidth(self.tab_comp_label.sizePolicy().hasHeightForWidth())
        self.tab_comp_label.setSizePolicy(sizePolicy3)
        ...
        sizePolicy7.setHeightForWidth(self.compView.sizePolicy().hasHeightForWidth())
        self.compView.setSizePolicy(sizePolicy7)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/flask.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/beaker-empty.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        sizePolicy6.setHeightForWidth(self.Settings.sizePolicy().hasHeightForWidth())
        self.Settings.setSizePolicy(sizePolicy6)
        ...
        sizePolicy8.setHeightForWidth(self.dmodeSelector.sizePolicy().hasHeightForWidth())
        self.dmodeSelector.setSizePolicy(sizePolicy8)
        ...
        sizePolicy8.setHeightForWidth(self.dmode_label.sizePolicy().hasHeightForWidth())
        self.dmode_label.setSizePolicy(sizePolicy8)
        ...
        sizePolicy4.setHeightForWidth(self.dmode.sizePolicy().hasHeightForWidth())
        self.dmode.setSizePolicy(sizePolicy4)
        ...
        sizePolicy3.setHeightForWidth(self.dmode0Input.sizePolicy().hasHeightForWidth())
        self.dmode0Input.setSizePolicy(sizePolicy3)
        ...
        self.dmode0_concView.setObjectName(u"dmode0_concView")
        ...
        self.dmode1Input.setObjectName(u"dmode1Input")
        sizePolicy3.setHeightForWidth(self.dmode1Input.sizePolicy().hasHeightForWidth())
        self.dmode1Input.setSizePolicy(sizePolicy3)
        ...
        self.dmode1_concView.setObjectName(u"dmode1_concView")
        ...
        sizePolicy2.setHeightForWidth(self.calcButton.sizePolicy().hasHeightForWidth())
        self.calcButton.setSizePolicy(sizePolicy2)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"SuperSimpleSpeciesCalculator", None))
...
#endif // QT_CONFIG(tooltip)
        self.sys_opt_label.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-weight:600;\">System Options</span></p></body></html>", None))
        self.comp_label.setText(QCoreApplication.translate("MainWindow", u"N\u00b0 Comp.", None))
...
#endif // QT_CONFIG(statustip)
        self.calc_opt_label.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-weight:600;\">Calculation Options</span></p></body></html>", None))
...
#endif // QT_CONFIG(statustip)
        self.relErrorMode_label.setText(QCoreApplication.translate("MainWindow", u"Relative Errors", None))
        self.relErrorMode.setItemText(0, QCoreApplication.translate("MainWindow", u"Yes", None))
        self.relErrorMode.setItemText(1, QCoreApplication.translate("MainWindow", u"No", None))
        ...
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.species), QCoreApplication.translate("MainWindow", u"Solution Species", None))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.solidspecies), QCoreApplication.translate("MainWindow", u"Solid Species", None))
...
#endif // QT_CONFIG(statustip)
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-weight:600;\">Initial and Titrant concentration:</span></p></body></html>", None))
...
#if QT_CONFIG(statustip)
        self.c0back.setStatusTip(QCoreApplication.translate("MainWindow", u"Initial concentration of beckground ions in titration vessel.", None))
#endif // QT_CONFIG(statustip)
        ...
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-weight:600;\">Analytical concentration:</span></p></body></html>", None))
        ...
        self.indComp_label.setText(QCoreApplication.translate("MainWindow", u"Indipendent Comp A:", None))
#if QT_CONFIG(statustip)
