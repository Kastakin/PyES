...
class Ui_inputTitrationOpt(object):
    ...
    def retranslateUi(self, inputTitrationOpt):
        ...
        self.test1Label.setText(
            QCoreApplication.translate("inputTitrationOpt", "Test1", None)
        )
        self.test2Label.setText(
            QCoreApplication.translate("inputTitrationOpt", "Test2", None)
        )
